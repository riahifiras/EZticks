...
const Nav = () => {
  ...
  const dropdownItems = {
    events: [
      ...
      { href: "#", label: "Popular Events" },
    ],
    deals: [
      { href: "#", label: "Exclusive Offers" },
      { href: "#", label: "Early Bird Tickets" },
      { href: "#", label: "Last Minute Deals" },
    ],
    about: [
        ...
        >
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <NavButtonDropdown
              ...
              toggleDropdown={() => toggleDropdown('events')}
            />
            <NavButtonDropdown
              label="Deals"
              items={dropdownItems.deals}
              isOpen={openDropdown === 'deals'}
              toggleDropdown={() => toggleDropdown('deals')}
            />
            <NavButtonDropdown
              label="About Us"
